...
function Emi_card(props){
    ...
    return(
  <div className="mt-3">
    <div className={`bg-white p-4 rounded-lg border-l-4 ${installment.paid?"border-green-600":"border-red-600"}`}>
        ...
        <div className="flex gap-2 items-center justify-center">
           ...
           <div>
            ...
            <h1 className="flex text-sm"><IndianRupee className="h-5 w-3"/>{installment.installmentamount}</h1>
          </div>
        </div>
        <div className="">
